...
class UserAddressPage(BasePage):
    ...
    def add_address(self, alias, name, phone, address):
        self.send_keys(self.UserAddressPageRsrc.LOC_别名框, alias)
        self.send_keys(self.UserAddressPageRsrc.LOC_姓名框, name)
        self.send_keys(self.UserAddressPageRsrc.LOC_电话框, phone)
        self.send_keys(self.UserAddressPageRsrc.LOC_详细地址框, address)
        self.sleep(1)
        self.click(self.UserAddressPageRsrc.LOC_省下拉按钮)
        self.sleep(1)
        self.click(self.UserAddressPageRsrc.LOC_选择省)
        self.sleep(1)
        self.click(self.UserAddressPageRsrc.LOC_市下拉框按钮)
        self.sleep(1)
        self.click(self.UserAddressPageRsrc.LOC_选择市)
        self.sleep(1)
        self.click(self.UserAddressPageRsrc.LOC_区下拉框按钮)
        self.sleep(1)
        self.click(self.UserAddressPageRsrc.LOC_选择区)
        self.scroll_into_view_by_js(self.UserAddressPageRsrc.LOC_保存按钮)
        self.sleep(1)
        self.click(self.UserAddressPageRsrc.LOC_保存按钮)
        self.sleep(0.5)
